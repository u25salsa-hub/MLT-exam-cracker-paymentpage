    ...
    <section className="py-24 bg-white" id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600">Get everything you need to succeed for just <span className="text-teal-600 font-bold">₹249</span></p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FeatureCard 
            title="1000+ High-Yield MCQs"
            description="Carefully selected questions for AIIMS CRE, DSSSB, Railway, and ESIC exams to maximize your scoring potential."
            icon={
          ...
          />
          <FeatureCard 
            title="Latest Exam Trends"
            description="Updated AIIMS CRE pattern questions based on the latest 2024-2025 trends to keep your preparation relevant."
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <FeatureCard 
            ...
            description="Dedicated sections for Hematology, Microbiology, Biochemistry, and more to strengthen your weak areas."
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
